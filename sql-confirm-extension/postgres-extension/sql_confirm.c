                                       ...
                                       QueryCompletion *qc)
{
    ...
    bool has_where = true; /* conservative default */
    ...
    {
        /* naive scan for token CONFIRM in the raw query text */
...
void _PG_init(void)
{
    /* In the future we could expose a GUC to enable/disable behavior */
